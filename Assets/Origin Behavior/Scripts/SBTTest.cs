...
public class SBTTest : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        ConditionalNode condition2 = new ConditionalNode((owner) =>
        {
            return _forPoint1 ? BehaviorStatus.Sucess : BehaviorStatus.Failure;
        });
        ...
        ActionNode rotateToPoint3= new ActionNode((owner) =>
        {
            _target.LookAt(_point1);
            return BehaviorStatus.Sucess;
        });
        ...
        seq3.AddNodes(condition2, rotateToPoint3);
        
        Sequencer seq1_ = new Sequencer();
        seq1_.NeedsConditionalAbort = true;
        seq1_.AddNodes(condition, rotateToPoint1, movetoPoint1);
        
        Sequencer seq1 = new Sequencer();
        seq1.NeedsConditionalAbort = true;
        //seq1.AddNodes(seq3,condition, rotateToPoint1, movetoPoint1);
        //seq1.AddNodes(seq3,seq1_);
